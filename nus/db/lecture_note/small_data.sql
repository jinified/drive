...
Insert into STUDENT (NAME,EMAIL,YEAR,FACULTY,DEPARTMENT,GRADUATE) values ('GOH HUI YING','gohhuiying1989@gmail.com','2008-01-01','Faculty of Science','Biology','2012-01-01');
Insert into STUDENT (NAME,EMAIL,YEAR,FACULTY,DEPARTMENT,GRADUATE) values ('TAY WEI GUO','tayweiguo1989@msn.com','2010-08-01','Faculty of Engineering','CE','2013-01-01');
Insert into STUDENT (NAME,EMAIL,YEAR,FACULTY,DEPARTMENT,GRADUATE) values ('PENG JIAYUAN','pengjiayuan2011@hotmail.com','2008-01-01','Faculty of Science','Biology',null);
...
Insert into STUDENT (NAME,EMAIL,YEAR,FACULTY,DEPARTMENT,GRADUATE) values ('LIU ZHANPENG','liuzhanpeng2011@msn.com','2007-08-01','Faculty of Science','Chemistry',null);
Insert into STUDENT (NAME,EMAIL,YEAR,FACULTY,DEPARTMENT,GRADUATE) values ('HUANG WENXIN','huangwenxin2010@msn.com','2008-01-01','Faculty of Science','Math','2014-01-01');
Insert into STUDENT (NAME,EMAIL,YEAR,FACULTY,DEPARTMENT,GRADUATE) values ('WANG NA','wangna1990@yahoo.com','2010-01-01','Faculty of Engineering','EE',null);
Insert into STUDENT (NAME,EMAIL,YEAR,FACULTY,DEPARTMENT,GRADUATE) values ('NG ANH QUANG','nganhquang1991@yahoo.com','2009-08-01','Faculty of Engineering','ME','2014-08-01');
Insert into STUDENT (NAME,EMAIL,YEAR,FACULTY,DEPARTMENT,GRADUATE) values ('POH HUI LING','pohhuiling1992@hotmail.com','2007-01-01','Faculty of Science','Biology',null);
Insert into STUDENT (NAME,EMAIL,YEAR,FACULTY,DEPARTMENT,GRADUATE) values ('NG QI YANG','ngqiyang1989@msn.com','2009-01-01','Faculty of Engineering','CE',null);
...
Insert into STUDENT (NAME,EMAIL,YEAR,FACULTY,DEPARTMENT,GRADUATE) values ('LIU SHAOJUN','liushaojun2010@msn.com','2007-08-01','School of Computing','CS',null);
Insert into STUDENT (NAME,EMAIL,YEAR,FACULTY,DEPARTMENT,GRADUATE) values ('QIN YIYANG','qinyiyang2010@hotmail.com','2007-01-01','School of Computing','CS','2014-08-01');
Insert into STUDENT (NAME,EMAIL,YEAR,FACULTY,DEPARTMENT,GRADUATE) values ('TAY YONG MING','tayyongming1989@gmail.com','2009-01-01','Faculty of Engineering','CE',null);
Insert into STUDENT (NAME,EMAIL,YEAR,FACULTY,DEPARTMENT,GRADUATE) values ('SIOW CAO KHOA','siowcaokhoa1991@msn.com','2010-08-01','School of Computing','CS',null);
Insert into STUDENT (NAME,EMAIL,YEAR,FACULTY,DEPARTMENT,GRADUATE) values ('CHOY YI TING','choyyiting1992@hotmail.com','2009-08-01','Faculty of Science','Biology',null);
Insert into STUDENT (NAME,EMAIL,YEAR,FACULTY,DEPARTMENT,GRADUATE) values ('DENNIS BECKHAM','dennisbeckham1989@msn.com','2010-08-01','School of Computing','IS',null);
Insert into STUDENT (NAME,EMAIL,YEAR,FACULTY,DEPARTMENT,GRADUATE) values ('FENG MENG','fengmeng1990@gmail.com','2007-01-01','Faculty of Science','Biology',null);
...
Insert into STUDENT (NAME,EMAIL,YEAR,FACULTY,DEPARTMENT,GRADUATE) values ('ZHANG HONG','zhanghong2011@msn.com','2010-08-01','School of Computing','IS',null);
...
Insert into STUDENT (NAME,EMAIL,YEAR,FACULTY,DEPARTMENT,GRADUATE) values ('LIU YIHUI','liuyihui1990@hotmail.com','2008-01-01','Faculty of Science','Biology',null);
...
Insert into STUDENT (NAME,EMAIL,YEAR,FACULTY,DEPARTMENT,GRADUATE) values ('ZHENG XI','zhengxi1990@yahoo.com','2010-01-01','School of Computing','IS',null);
...
Insert into STUDENT (NAME,EMAIL,YEAR,FACULTY,DEPARTMENT,GRADUATE) values ('DAVID CHAPMAN','davidchapman1989@msn.com','2008-01-01','School of Computing','CS',null);
Insert into STUDENT (NAME,EMAIL,YEAR,FACULTY,DEPARTMENT,GRADUATE) values ('QIN YUWEI','qinyuwei2011@hotmail.com','2009-08-01','School of Computing','CS',null);
Insert into STUDENT (NAME,EMAIL,YEAR,FACULTY,DEPARTMENT,GRADUATE) values ('DENNIS PALMER','dennispalmer1992@yahoo.com','2010-01-01','Faculty of Engineering','ME',null);
...
Insert into STUDENT (NAME,EMAIL,YEAR,FACULTY,DEPARTMENT,GRADUATE) values ('DING WEI XIANG','dingweixiang1990@yahoo.com','2010-01-01','School of Computing','IS',null);
Insert into STUDENT (NAME,EMAIL,YEAR,FACULTY,DEPARTMENT,GRADUATE) values ('IRIS BROWN','irisbrown1992@hotmail.com','2008-08-01','School of Computing','CS',null);
...
Insert into STUDENT (NAME,EMAIL,YEAR,FACULTY,DEPARTMENT,GRADUATE) values ('GE DUO','geduo2010@yahoo.com','2009-08-01','Faculty of Engineering','ME',null);
Insert into STUDENT (NAME,EMAIL,YEAR,FACULTY,DEPARTMENT,GRADUATE) values ('HUANG XUANTI','huangxuanti1992@msn.com','2007-08-01','School of Computing','IS',null);
Insert into STUDENT (NAME,EMAIL,YEAR,FACULTY,DEPARTMENT,GRADUATE) values ('LISA SMITH','lisasmith2011@msn.com','2007-08-01','Faculty of Science','Chemistry',null);
Insert into STUDENT (NAME,EMAIL,YEAR,FACULTY,DEPARTMENT,GRADUATE) values ('NG YONG MING','ngyongming2011@yahoo.com','2009-08-01','School of Computing','CS',null);
...
Insert into STUDENT (NAME,EMAIL,YEAR,FACULTY,DEPARTMENT,GRADUATE) values ('NG YAN FEN','ngyanfen2010@msn.com','2008-01-01','School of Computing','CS',null);
Insert into STUDENT (NAME,EMAIL,YEAR,FACULTY,DEPARTMENT,GRADUATE) values ('ANG JIA YI','angjiayi1990@hotmail.com','2009-08-01','School of Computing','CS',null);
...
Insert into STUDENT (NAME,EMAIL,YEAR,FACULTY,DEPARTMENT,GRADUATE) values ('NGOO KAI TING','ngookaiting1991@yahoo.com','2010-08-01','School of Computing','CS',null);
Insert into STUDENT (NAME,EMAIL,YEAR,FACULTY,DEPARTMENT,GRADUATE) values ('TSO HUI LIN','tsohuilin1989@msn.com','2007-08-01','Faculty of Science','Physics',null);
Insert into STUDENT (NAME,EMAIL,YEAR,FACULTY,DEPARTMENT,GRADUATE) values ('LIU ZHENCAI','liuzhencai1990@msn.com','2010-08-01','School of Computing','CS',null);
